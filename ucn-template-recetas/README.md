...
Sube este proyecto a GitHub, importalo en Vercel, usa la version de Node configurada en el deployment, agrega variables de entorno y registra el dominio final en Supabase Auth. El proyecto solo declara minimos en `engines`, asi que Node/npm mas nuevos son validos.
